...
<form name="myForm" class="form-horizontal" method="post" onsubmit="return validateForm()">
...
<input type="text" class="form-control" name="email" id="email" placeholder="Enter your Password"/>
</div>
</div>
</div>
